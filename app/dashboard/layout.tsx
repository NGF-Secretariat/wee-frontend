...
import { TopbarFiltersProvider, useTopbarFilters } from "../context/TopbarFiltersContext";
...
export default function DashboardLayout({
  ...
  const sidebarWidth = (collapsed && !hovered && !mobileOpen) ? 80 : 256;
  const contentMargin = collapsed ? 80 : 256;
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ "--sidebar-width": `${contentMargin}px` } as any}
      >
        {/* Sidebar */}
        <div
          ...
          className={`
            fixed left-0 top-0 h-full z-40 transition-all duration-300 bg-white shadow
        ...
        {/* Main area */}
        <div className="flex bg-[#ecf1ec] flex-col flex-1 transition-all duration-300 ease-in-out md:ml-[var(--sidebar-width)]">
